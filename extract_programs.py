...
def main(input_file=None, output_file=None):
    ...
    ----------------------------------------------------------------
    input_file  : str | None  Path to MOSAIC_CONVERT Excel file
    output_file : str | None  Path for the output SAS script (.txt)
    """
    print("=" * 80)
    ...
    # Select input file (dialog if not provided)
    ...
    # Select output file (dialog if not provided)
